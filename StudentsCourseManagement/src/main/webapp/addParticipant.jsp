...
<hr>
  ...
  <h5 >Please enter valid details to enroll a participant </h5>
  <br>
  <br>
<div class="form-group add-form mx-auto w-50"  >

<form action="addParticipant" method="post" id="myForm" onsubmit="handleSubmit()">
...
<label for="skills"  > skills :</label>	&nbsp;		<input type="checkbox"  name="skills"	value="Java" />	Java
																	...
																	&nbsp;&nbsp;<input type="checkbox"  name="skills"	value="datastructure"/>	DataStructures
																		<br> 
																		<br>
<label for="course"  > enroll courses :</label>		<br>	<input type="checkbox"  name="course"	value="Java" />	Full Stack Java Developer
