...
<hr>
<h5> please enter batch information</h5>
<p> Note: Please enter batch id as per in the list of batches.
<div class="form-group w-50 mx-auto">
<form  action="addBatch" method="post" class="myForm" onsubmit="handleSubmit()">
